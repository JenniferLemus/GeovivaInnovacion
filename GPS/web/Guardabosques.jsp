...
<html lang="zxx">
    ...
    <head>
        <title>Registrar Guardabosques</title>
        <!-- Meta-Tags -->
        ...
        <div class="formulario" >
            <div class="form-w3ls">
                <ul class="tab-group cl-effect-4">
                    <li class="tab active"><a href="#signin-agile">Registrar guardabosques</a></li>
                </ul>
                <div class="tab-content">
                    <div id="signin-agile">   
                        <form action="Guardabosques" method="post">
                            ...
                            <p class="header">Poblacion aledaña</p>
                            <input type="text" name="poblacionAledana" placeholder="Poblacion Aledaña" required="">

                            <p class="header">Tipo de documento</p>
