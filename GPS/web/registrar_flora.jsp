...
<html lang="zxx">
 ...
 <body id="body"  style="background-image: url(images/Registrar_Flora.jpg)">
        ...
        <div class="formulario" >
            <div class="form-w3ls">
                <ul class="tab-group cl-effect-4">
                    <li class="tab active"><a href="#signin-agile">Registrar flora</a></li>
                </ul>
                <div class="tab-content">
                    <div id="signin-agile">   
                        <form action="Flora" method="post">

                            <p class="header">Tipo</p>
                            <select class="sign-in" name="tipo" >
                                <option name="">Natural</option>
                                <option name="">Artificial</option>
                            </select>

                            <p class="header">Numero de individuos</p>
                            <input type="text" name="numeroIndividuos" placeholder="Numero de individuos" required="">

                            <p class="header">Tamaño</p>
