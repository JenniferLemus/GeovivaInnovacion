 ...
 * @author UserData05
 */
@WebServlet(name = "ServletGeologo", urlPatterns = {"/Geologo"})
public class ServletGeologo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id_geologo = request.getParameter("geologo");
        ...
        BeanGeologo Bgeologo = new BeanGeologo(id_geologo, nombre, apellido, telefono, tipoDocumento, numeroDocumento, correo, entidad);
        DaoGeologo Dgeologo = new DaoGeologo(Bgeologo);
        ...
        break;
          ...
          case 3 : //Consulta actualizacion 
              BeanGeologo BGe = DaoGeologo.consultaporidentificador(id_geologo);
              if (BGe != null) {
                  
                  request.setAttribute("bGeologo", BGe);
                  request.getRequestDispatcher("actualizar_Geologo.jsp").forward(request, response);
